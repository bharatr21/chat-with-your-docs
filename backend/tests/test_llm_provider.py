...
class TestLLMProvider:
    ...
    def test_create_openai_llm(self, mock_openai, mock_get_provider, mock_is_available, monkeypatch):
    ...
    def test_create_google_llm(self, mock_google, mock_get_provider, mock_is_available, monkeypatch):
    ...
    def test_create_llm_default_parameters(self):
        ...
        with patch('app.services.llm.provider.ModelRegistry.is_model_available', return_value=True):
            with patch('app.services.llm.provider.ModelRegistry.get_provider', return_value="OpenAI"):
